...
namespace Assets.UI.ConstructionZones.ForTesting {
    ...
    public class MockZoneManipulationSimulationControl : SimulationControlBase {
        ...
        public event EventHandler<IntEventArgs> OnConstructionZoneDestructionRequested;
        ...
        public override void DestroyConstructionZone(int zoneID) {
            if(OnConstructionZoneDestructionRequested != null) {
                OnConstructionZoneDestructionRequested(this, new IntEventArgs(zoneID));
            }
        }
