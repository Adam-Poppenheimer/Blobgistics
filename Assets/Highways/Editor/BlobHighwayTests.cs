...
namespace Assets.Highways.Editor {
    ...
    public class BlobHighwayTests {
        ...
        public void OnProfileChanged_BlobSpeedPerSecondChangesForBothTubes() {
            ...
            //Execution
            highwayToTest.Profile = new BlobHighwayProfile(5, 20, ResourceSummary.BuildResourceSummary(highwayToTest.gameObject), 1f);
        ...
        private BlobHighwayFactory BuildHighwayFactory() {
            ...
            newHighwayFactory.StartingProfile = new BlobHighwayProfile(1, 10,
