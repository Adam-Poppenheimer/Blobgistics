...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /productName "Blobgistics Documentation" /mediaBookList "Blobgistics Documentation" > NUL
...
REM build time.
IF EXIST "BlobgisticsDocumentation.msha" COPY /Y "BlobgisticsDocumentation.msha" HelpContentSetup.msha
...
REM Uninstall first in case it is already there.  If not, it won't install below.  We'll ignore any error output
REM by redirecting it to NUL.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Vendor Name" /productName "Blobgistics Documentation" /bookList "Blobgistics Documentation" > NUL

REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\BlobgisticsDocumentation.msha"
